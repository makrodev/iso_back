# Generated by Django 4.1 on 2022-12-15 06:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to='uploads/photo/')),
                ('response_person_description', models.TextField(blank=True, null=True)),
                ('result_action', models.TextField(blank=True, null=True)),
                ...
                ('process', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.process')),
                ('region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.region')),
                ('response_admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
